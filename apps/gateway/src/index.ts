...
const siteId = requiredEnv("GATEWAY_SITE_ID");
const gatewayId = requiredEnv("GATEWAY_ID");
const gatewaySerial = requiredEnv("GATEWAY_SERIAL");
...
client.on("message", (topic, payload) => {
  ...
  if (topic === mqttTopics.provisionDevice(siteId, gatewayId)) {
    void handleProvisionDevicePayload(payload);
  }
});
